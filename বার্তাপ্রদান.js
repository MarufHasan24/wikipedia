(function () {
  ...
  var sidebarObj = {
    vector: "mw-panel",
    monobook: "column-content" || "globalWrapper",
    timeless: "personal-inner",
    minerva: "mw-mf-page-left",
  ...
  //desided sidebar
  var sidebar = document.getElementById(sidebarObj[mw.config.get("skin")]); //mobile;
  //সমস্যা
  var problems = [
    "COI",
    "Close paraphrasing",
    ...
    "আত্মজীবনী",
    "আরও পাদটীকা",
    /* "ইতিহাস একীকরণ", প্রয়োজন নেই, প্রশাশকের কাজ*/
    "উদ্ধৃতিদান শৈলী",
    "উল্লেখযোগ্যতা",
    "উৎসহীন",
    "একটি উৎস",
    ...
    "জী-ব্য-জী উৎসহীন",
    "জী-ব্য-জী তথ্যসূত্র",
    /*"নতুন অপর্যালোচিত নিবন্ধ", দরকার নেই*/
    "নিরপেক্ষতা",
    "পরিষ্করণ",
    "পরিষ্করণ-পুনঃসংগঠন",
    "পাদটীকা নেই",
  ...
  var problemDes = {
    COI: {
      des: "'''নিবন্ধটির বিষয়বস্তুর সাথে আপনার [[উইকিপিডিয়া:স্বার্থের সংঘাত|গভীর সম্পৃক্ততা]] রয়েছে বলে প্রতিয়মান হয়।''' উইকিপিডিয়ার নীতিমালা, বিশেষ করে [[উইকিপিডিয়া:নিরপেক্ষ দৃষ্টিভঙ্গি|নিরপেক্ষ দৃষ্টিভঙ্গি]] অনুযায়ী এই নিবন্ধটি পরিষ্কার করা দরকার",
      soln: "নিবন্ধটির আলাপ পাতায় [[উইকিপিডিয়া:স্বার্থের সংঘাত|আপনার এই সম্পৃক্ততা]] সম্পর্কে আপনার মতামত লিখুন অথবা এই নিবন্ধটি পুনরায় লিখুন",
    },
    "Close paraphrasing": {
      des: "নিবন্ধটিতে অনেক কপিরাইট যুক্ত উক্তি দ্বারা লেখা হয়েছে",
      soln: "কপিরাইটযুক্ত লেখা সমূহ সরিয়ে ফেলুন এবং নিজের ভাষায় লিখুন",
    },
    Hoax: {
    ...
    "In-universe": {
      ...
      soln: "অনুগ্রহ করে নিবন্ধটির বিষয়বস্তু আরও স্পষ্টভাবে ব্যাখ্যা করতে এবং অ-কাল্পনিক দৃষ্টিকোণ প্রদান করতে এটিকে পুনরায় লিখতে সহায়তা করুন।",
    },
    "Merge to": {
      des: "নিবন্ধটি অন্য এক একাধিক নিবন্ধের সাথে একত্রীকরণ করা প্রয়োজন",
      soln: "আপনার নিবন্ধটির সাথে অন্য নিবন্ধের বিষয়বস্তু ও রচনাশৈলীর সাদৃশ্য রয়েছে। আপনি এ সম্পর্কে নিবন্ধটির আলাপ পাতায় আলোচনা করতে পারেন",
    },
    Peacock: {
      des: "নিবন্ধটিতে আত্মশ্লাঘাকারী পদ থাকতে পারে যা শুধু তথ্য যোগ ছাড়াও অন্য বিষয়কে প্রচার করছে বলে প্রতীয়মান হয়",
      soln: "অনুগ্রহ করে '''বিষয়বস্তুর তাৎপর্য ঘোষনা বা প্রচার করে এমন শব্দসমূহ অপসারণ বা প্রতিস্থাপন করুন'''। বিষয়বস্তু সম্পর্কে কেবল প্রকৃত সত্য তুলে ধরুন এবং স্বীকৃতি উদ্ধৃতি উল্লেখের মাধ্যমে গুরুত্ব নির্দেশ করুন",
    },
    Plot: {
      ...
      soln: "দয়া করে অপ্রয়োজনীয় ও অপেক্ষাকৃত কম গুরুত্বপূর্ণ বর্ণনা বাদ দিয়ে এবং একে আরও সংক্ষিপ্ত করে নিবন্ধটি উন্নয়নে সহায়তা করুন। আপনি চাইলে নিবন্ধটিকে বিষয়বস্তু আকারে ভাগ করে সেখানে এই তথ্যগুলো যোগ করতে পারেন।",
    },
    Recentism: {
      ...
      soln: "অনুগ্রহ করে এই ঘটনাসমূহকে ঐতিহাসিক দৃষ্টিকোণ থেকে উল্লেখের চেষ্টা করুন এবং নিবন্ধটি পুনরায় লিখুন",
    },
    "Too few opinions": {
      ...
      soln: `অনুগ্রহ করে নিবন্ধটির মানোন্নয়ন করুন অথবা নিবন্ধটির আলাপ পাতায় আলোচনা করুন`,
    },
    Weasel: {
      des: "নিবন্ধটিতে কিছু অগ্রহনযোগ্য শব্দ বা অস্পষ্ট বাক্যাংশ যা প্রায়শই [[উইকিপিডিয়া:Neutral point of view|পক্ষপাতমূলক]] বা [[উইকিপিডিয়া:যাচাইযোগ্যতা|যাচাই করা যায় না]] এমন তথ্য রয়েছে, যা উইকিপিডিয়ার রচনাশৈলী মতে ঠিক নয়",
    ...
    "অনির্ভরযোগ্য তথ্যসূত্র": {
      des: "নিবন্ধটির এক বা একাধিক তথ্যসূত্র [[উইকিপিডিয়া:নির্ভরযোগ্য উৎস|নির্ভরযোগ্য]] নাও হতে পারে বলে মনে করা হয়েছে",
    ...
    "অনুলিপি সম্পাদনা": {
      des: "উইকিপিডিয়ার মানদণ্ড উত্তীর্ণের জন্য অনুলিপি সম্পাদনা করা প্রয়োজন। কারণ '''ব্যাকরণ, রচনাশৈলী, বানান বা বর্ণনাভঙ্গিগত সমস্যা রয়েছে। তাই এটিতে [[উইকিপিডিয়া:রচনা সংশোধন|রচনা সংশোধনের]] প্রয়োজন রয়েছে বলে প্রতীয়মান হয়'''",
    ...
    অসংযুক্ত: {
      ...
      soln: "অনুগ্রহ করে এই পাতাটি এর সম্পর্কিত নিবন্ধসমূহের সাথে সংযোগ করুন",
    },
    অসংলগ্ন: {
      ...
      soln: "নিবন্ধটির অপ্রাসঙ্গিক তথ্য অপসারণ করে, বা [[উইকিপিডিয়া:বিভক্তিকরণ|এটিকে বিভক্ত করে]] বিষয় অনুসারে একাধিক নিবন্ধ তৈরি করুন। এ সম্পর্কে অন্য কোন মতামত থাকলে নিবন্ধটির আলাপ পাতায় লিখুন",
    },
    আত্মজীবনী: {
      ...
      soln: "আপনি এটিকে [[উইকিপিডিয়া:আত্মজীবনী|আত্মজীবনী]] মনে না করলে বা অন্য কোনো মতামত থাকলে তা নিবন্ধটির আলাপ পাতায় ব্যক্ত করতে পারেন",
    },
    "আরও পাদটীকা": {
    ...
    উল্লেখযোগ্যতা: {
      ...
      soln: "নিবন্ধটির উল্লেখযোগ্যতা প্রতিষ্ঠার জন্য বিষয়বস্তু প্রসারিত করুন, [[উইকিপিডিয়া:নির্ভরযোগ্য উৎস|বিশ্বস্ত সূত্র]] থেকে [[উইকিপিডিয়া:উৎসনির্দেশ|সত্যতা]] প্রমাণ করুন। যদি উল্লেখযোগ্যতা প্রমাণ না হয়, তাহলে এ নিবন্ধটি [[উইকিপিডিয়া:অপসারণ নীতি|অপসারণ নীতি]] অনুযায়ী মুছে ফেলার যোগ্য বলে বিবেচিত হবে অথবা এ সম্পর্কিত অন্য নিবন্ধে এটিকে [[উইকিপিডিয়া:একীকরণ|একীকরণ]] করা হবে",
    },
    উৎসহীন: {
    ...
    একীকরণ: {
      des: "নিবন্ধটি অন্য একটি নিবন্ধটির সাথে একত্রীকরণ করার প্রস্তাব করা হয়েছে",
      soln: "আপনার যদি একীকরণে আপত্তি থাকে, তবে নিবন্ধটির আলাপ পাতায় এ সম্পর্কে আলোচনা করতে পারেন",
    },
    কমসংযুক্ত: {
    ...
    "কারিগরি পরিভাষার আধিক্য": {
      ...
      soln: "অনুগ্রহ করে কারিগরি তথ্য অপসারণ না করে [[উইকিপিডিয়া:কারিগরি নিবন্ধগুলি বোধগম্য করুন|অনভিজ্ঞ সাধারণ পাঠকের নিকট আরও বেশি বোধগম্য]] করুন। আলাপ পাতায় এ বিষয়ে আরও বিস্তারিত থাকতে পারে",
    },
    কাল্পনিক: {
      ...
      soln: "কাল্পনিক গল্পের নির্দেশিকা অনুযায়ী এটি পুনরায় লিখুন",
    },
    "খালি ইউআরএল পরিষ্কারকরণ": {
    ...
    গদ্য: {
      ...
      soln: "[[উইকিপিডিয়া:রচনাশৈলী নির্দেশনা/অন্তর্নিবন্ধ তালিকা#তালিকার_উপযুক্ত_ব্যবহার|উপযুক্ত যায়গায়]] আপনি এ নিবন্ধটি গদ্যে লিখে সাহায্য করতে পারেন। প্রয়োজনে [[সাহায্য:সূচী|সম্পাদনা সহায়িকা]] দেখুন",
    },
    "ছোট নিবন্ধ": {
    ...
    নিরপেক্ষতা: {
      ...
      soln: "প্রাসঙ্গিক আলোচনা নিবন্ধটির আলাপ পাতায় পাওয়া যেতে পারে। অনুগ্রহ করে [[উইকিপিডিয়া:সংঘাত নিরসন#সংঘাত নিরসন|বিতর্ক নিরসন]] হওয়ার আগ পর্যন্ত {{tl|নিরপেক্ষতা টেমপ্লেটটি}} সরিয়ে ফেলবেন না",
    },
    পরিষ্করণ: {
      ...
      soln: "নিবন্ধটিতে [[উইকিপিডিয়া:নিবন্ধ ত্রুটি দূরীকরণ|পরিচ্ছন্ন]] সমস্যা সম্পর্কে আরো বিস্তারিত থাকতে পারে। এর আলাপ পাতায় প্রাসঙ্গিক আলোচনা পাওয়া যেতে পারে। নিবন্ধটি পরিষ্কার করার আগ পর্যন্ত {{tl|পরিষ্করণ}} টেমপ্লেটটি সরিয়ে ফেলবেন না",
    },
    "পরিষ্করণ-পুনঃসংগঠন": {
    ...
    "পাদটীকা নেই": {
      ...
      soln: "বিষয়বস্তুকে স্পষ্ট করতে প্রয়োজনমতো টীকা যোগ করুন",
    },
    "পুরোটাই দৃশ্যপট": {
      des: "নিবন্ধটি '''প্রায় পুরোটাই একটি [[উইকিপিডিয়া:What Wikipedia is not#PLOT|দৃশ্যপট]]'''",
      soln: "বিশ্বকোষীয় নিবন্ধের নীতিমালা মেনে এর পরিবর্ধন করা দরকার। অনুগ্রহ করে বিষয়বস্তুর উপর ভিত্তি করে নিবন্ধটি সম্পাদনা করুন",
    },
    "প্রাথমিক উৎস": {
    ...
    "বর্ণনা ভঙ্গি": {
      ...
      soln: "অনুলিপি সম্পাদনা করে বর্ণনা ভঙ্গি ঠিক করুন। নির্দেশনা পেতে [[উইকিপিডিয়া:Guide to writing better articles|সঠিক নিবন্ধ লেখার নির্দেশনা]] দেখুন। এই ব্যাপারে নির্দিষ্ট আলোচনা [[টেমপ্লেট আলোচনা:বর্ণনা ভঙ্গি|আলাপ পাতায়]] পাওয়া যেতে পারে",
    },
    বহিঃসংযোগসমূহ: {
    ...
    "বাংলা নয়": {
      ...
      soln: "দয়া করে এ ধরনের লেখাগুলো প্রথমে হাতে করে অনুবাদ করুন। এরপর অনুবাদকৃত লেখাগুলো সম্পাদনা করে নিবন্ধটিকে বাংলায় লিখুন",
    },
    বিজ্ঞাপন: {
      des: "নিবন্ধটি বিজ্ঞাপনের মতো করে লেখা হয়েছে যা উইকিপিডিয়ার রচনাশৈলী অনুযায়ী ঠিক নয়",
    ...
    বিতর্কিত: {
      des: "নিবন্ধটির তথ্যসমূহের '''যথার্থতা সম্পর্কে [[উইকিপিডিয়া:Accuracy dispute|বিতর্ক]] রয়েছে'''বলে প্রতীয়মান হয়",
    ...
    বিভ্রান্তিকর: {
      ...
      soln: "[[উইকিপিডিয়া:Please clarify|বিভ্রান্তি]] নিরসন করুন। অবোধ্য ভাষা ও শব্দ পরিহার করে নিবন্ধটির মানোন্নয়ন করুন ।নিবন্ধের আলাপ পাতায় এ বিষয়ে প্রয়োজনীয় দিকনির্দেশনা থাকতে পারে",
    },
    "বিষয়শ্রেণী উন্নয়ন": {
      des: "নিবন্ধটিতে '''অতিরিক্ত অথবা আরো বৈশিষ্ট্যসূচক [[উইকিপিডিয়া:Categorization|বিষয়শ্রেণী]]''' প্রয়োজন",
      soln: "এটিতে আরো [[উইকিপিডিয়া:বিষয়শ্রেণীকরণ#Categorizing_pages|বিষয়শ্রেণী যোগ করুন]], যেন এটি এই বিষয়ের অন্যান্য নিবন্ধের সাথে আপনার নিবন্ধটি তালিকাভুক্ত করা যায়",
    },
    বিষয়শ্রেণীহীন: {
      des: "নিবন্ধটিতে কোনও '''[[উইকিপিডিয়া:বিষয়শ্রেণীকরণ|বিষয়শ্রেণী]] যোগ করা হয়নি'''",
      soln: "একটি [[উইকিপিডিয়া:বিষয়শ্রেণীকরণ#Categorizing_pages|বিষয়শ্রেণী যোগ করুন]], যেন এটি এই বিষয়ের অন্যান্য নিবন্ধের সাথে আপনার নিবন্ধটি তালিকাভুক্ত করা যায়",
    },
    "বৈশ্বিক দৃষ্টিভঙ্গি": {
    ...
    "ভূমিকাংশ অতি দীর্ঘ": {
      ...
      soln: "নিবন্ধের ভূমিকাংশ থেকে কিছু বিষয়বস্তু অপসারণ করুন।\n## আরও তথ্যের জন্য অনুগ্রহ করে [[উইকিপিডিয়া:Layout guide|লেআউট গাইড]] এবং উইকিপিডিয়ার [[উইকিপিডিয়া:Lead section guidelines|ভূমিকাংশ নির্দেশিকা]] পড়ুন",
    },
    "ভূমিকাংশ অনুপস্থিত": {
    ...
    "ভূমিকাংশ খুবই সংক্ষিপ্ত": {
      des: "প্রয়োজন নিবন্ধের [[উইকিপিডিয়া:ভূমিকাংশ|ভূমিকাংশ]], '''এর বিষয়বস্তুর যথাযথ [[উইকিপিডিয়া:Summary style|সার-সংক্ষেপ]] নয়'''",
    ...
    মেয়াদউত্তীর্ণ: {
      ...
      soln: "সাম্প্রতিক ঘটনা বা সদ্যলভ্য তথ্য প্রতিফলিত করার জন্য নিবন্ধটি হালনাগাদ করুন এবং এর উপর সম্ভাব্য আলোচনার জন্য নিবন্ধটির আলাপ পাতায় দেখুন বা আলোচনা শুরু করুন",
    },
    "মৌলিক গবেষণা": {
    ...
    "জীববিজ্ঞান-অসম্পূর্ণ": {
      des: "[[জীববিজ্ঞান]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "রসায়ন-অসম্পূর্ণ": {
      des: "[[রসায়ন]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
    ...
    "বিজ্ঞান-অসম্পূর্ণ": {
      des: "[[বিজ্ঞান]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "বিষমচাক্রিক-অসম্পূর্ণ": {
      des: "[[বিষমচাক্রিক]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "রসায়ন সম্পর্কিত নিবন্ধসমূহ, বিশেষ করে রাসায়নিক যৌগ সম্পর্কিত নিবন্ধগুলো স্বভাবতই বড় হয় না! তারপর এটি একটি জৈব যৌগ হওয়ায় নিবন্ধটি আরও সংক্ষিপ্ত তাই এসকল নিবন্ধের অনুবাদ অসম্পূর্ণ রাখবেন না",
    },
    "কম্পিউটার বিজ্ঞান-অসম্পূর্ণ": {
      des: "[[কম্পিউটার]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "গণিত-অসম্পূর্ণ": {
      des: "[[গণিত]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "অসম্পূর্ণ-জীবনী": {
      des: "[[জীবনী]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "ভৌগোলিক অবস্থান-অসম্পূর্ণ": {
    ...
    "প্রাণী অসম্পূর্ণ": {
      des: "[[প্রাণী]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "চিকিৎসা বিজ্ঞান-অসম্পূর্ণ": {
      des: "[[চিকিৎসা বিজ্ঞান]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "টেলিভিশন ধারাবাহিক অসম্পূর্ণ": {
      des: "[[টেলিভিশন ধারাবাহিক]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "চলচ্চিত্র-অসম্পূর্ণ": {
      des: "[[চলচ্চিত্র]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "চলচ্চিত্র বিষয়ক নিবন্ধসমূহে সাধারণত বেশি তথ্য থাকে না। তাই এই ধরনের নিবন্ধগুলো অসম্পূর্ণ রাখবেন না।\n## অন্তত পক্ষে শ্রেষ্ঠাংশ এবং কাহিনী অংশটি অসম্পূর্ণ রাখবেন না",
    },
    "ধর্ম-অসম্পূর্ণ": {
      des: "[[ধর্ম]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
  };
  //redirects
  problemDes.Condense = problemDes["অতিরিক্ত অনুচ্ছেদসমূহ"];
  problemDes["Cat improve"] = problemDes["বিষয়শ্রেণী উন্নয়ন"];
  problemDes["Improve categories"] = problemDes["বিষয়শ্রেণী উন্নয়ন"];
  problemDes["বিষয়শ্রেণী উন্নতি"] = problemDes["বিষয়শ্রেণী উন্নয়ন"];
  problemDes["হালনাগাদ"] = problemDes["মেয়াদউত্তীর্ণ"];
  problemDes["Essay-like"] = problemDes["রচনানুগ"];
  problemDes["আরও তথ্যসূত্র প্রয়োজন"] = problemDes["সূত্র উন্নতি"];
  ...
  if (
    ...
    sidebar.innerHTML +=
      '<button id="msg-send-tool" style="cursor:pointer; margin: 2.5px; height: 5vh; text-align: center;">অপেক্ষা করুন</button>';
    try {
      if (mw.config.get("skin") === "minerva") {
        document.getElementById("mw-mf-main-menu-button").onclick = finalTouch;
      } else {
        finalTouch();
      }
    } catch (e) {
      document.getElementById("msg-send-tool").innerHTML = "লোড করা সম্ভব হয়নি";
    }
  ...
  function finalTouch() {
    creatorLookOut(async function (params) {
      ...
      doButton.onclick = function () {
        if (creator === sender) {
          var disidecision = confirm("আপনি কি নিজেকে বার্তা দিতে চান?");
          if (disidecision) {
  ...
  function creatorLookOut(callbacks) {
    ...
    ts.lookupCreation(
      function (pageobj) {
        ...
        pageobj
          .getStatusElement()
          .info("তাকে পাওয়া গেছে" + params.initialContrib);
        callbacks(params);
      },
      function (pageobj) {
        pageobj.getStatusElement().info("কোন প্রকাশক পাওয়া যায়নি");
      }
    );
  }
  //choise message
    ...
    if (typeof strObj.problems !== "string") {
      ...
      if (tags && pagename && creator && creation && sender) {
        ...
        if (typeof strObj.problems === "object") {
          if (!multiple) {
            strObj.string = `<nowiki>{{subst:ব্যবহারকারী:মোহাম্মদ মারুফ/বার্তা প্রদান|page=${pagename}|problem=${strObj.problemDes}${strObj.suggesition}|creator=${creator}|sender=${sender}|days=${creationDate.days}|date=${creationDate.date}|sign=~~~~}}</nowiki>`;
          } else if (multiple === true && tags.length > 1) {
            strObj.string = `<nowiki>{{subst:ব্যবহারকারী:মোহাম্মদ মারুফ/বার্তা প্রদান-একাধিক|page=${pagename}|problem=${strObj.problemDes}${strObj.suggesition}|creator=${creator}|sender=${sender}|days=${creationDate.days}|date=${creationDate.date}|sign=~~~~}}</nowiki>`;
          }
        ...
        if (!pagename) {
          ...
          alert("প্রকাশক পাওয়া যায়নি");
        } else if (!creation) {
          alert("প্রকাশের সময় পাওয়া যায়নি");
        } else if (!sender) {
          alert("আপনার নাম পাওয়া যায়নি");
        } else if (!tags) {
      ...
      if (strObj.problems === "একাধিক") {
        ...
        alert("কোনো ট্যাগ পাওয়া যায়নি");
        return;
      } else {
        return;
      }
    ...
    if (rawtext.trim() !== "") {
      ...
      var notifytext =
        ...
        editsummary =
          ...
          "|" +
          sender +
          "]] [[ব্যবহারকারী:মোহাম্মদ মারুফ/বার্তাপ্রদান.js|বার্তাপ্রদান]] টুলটি ব্যবহার করে [[ব্যবহারকারী:" +
          creator +
          "|" +
          creator +
