(function () {
  ...
  var problems = [
    ...
    /*"নতুন অপর্যালোচিত নিবন্ধ", প্রয়োজন নেই, পর্যালোচকের কাজ */
  ...
  var problemDes = {
    ...
    "In-universe": {
      ...
      soln: "নিবন্ধটির বিষয়বস্তু আরও স্পষ্টভাবে ব্যাখ্যা করতে এবং অ-কাল্পনিক দৃষ্টিকোণ প্রদান করতে এটিকে পুনরায় লিখতে সহায়তা করুন।",
    },
    Peacock: {
    ...
    Recentism: {
      ...
      soln: "এই ঘটনাসমূহকে ঐতিহাসিক দৃষ্টিকোণ থেকে উল্লেখের চেষ্টা করুন এবং নিবন্ধটি পুনরায় লিখুন",
    },
    "Too few opinions": {
    ...
    "কারিগরি পরিভাষার আধিক্য": {
      ...
      soln: "কারিগরি তথ্য অপসারণ না করে [[উইকিপিডিয়া:কারিগরি নিবন্ধগুলি বোধগম্য করুন|অনভিজ্ঞ সাধারণ পাঠকের নিকট আরও বেশি বোধগম্য]] করুন। আলাপ পাতায় এ বিষয়ে আরও বিস্তারিত থাকতে পারে",
    },
    কাল্পনিক: {
    ...
    "এভিয়েশন-অসম্পূর্ণ": {
      des: "[[এভিয়েশন]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "ওয়েবসাইট অসম্পূর্ণ": {
      des: "[[ওয়েবসাইট]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "খাদ্য অসম্পূর্ণ": {
      des: "[[খাদ্য]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
    "অ্যানিমে-অসম্পূর্ণ": {
      des: "[[অ্যানিমে]] বিষয়ক নিবন্ধটি একটি অসম্পূর্ণ নিবন্ধ",
      soln: "",
    },
  };
  if (
              ...
              addToWatchlist(talkpage, function (data) {
                if (data.error) {
                  ...
                  api
                    .get({
                      action: "query",
                      titles: "ব্যবহারকারী:" + sender + "/বার্তাপ্রদান.json",
                      prop: "info",
                      inprop: "protection",
                    })
                    .then(function (data) {
                      if (!data.pages.missing) {
                        //read the json file
                        api
                          .get({
                            action: "query",
                            titles:
                              "ব্যবহারকারী:" + sender + "/বার্তাপ্রদান.json",
                            prop: "revisions",
                            rvprop: "content",
                          })
                          .then(function (data) {
                            saveInLogPage(
                              ...
                              function (datarry) {
                                ...
                                if (data.error && data2.error) {
                                  mw.notify(
                                    $(
                                      "<span>কোনো লগেই তথ্য যোগ করা যায়নি</span>"
                                    ),
                                    {
                                      type: "error",
                                      autoHideSeconds: 1,
                                  ...
                                  mw.notify(
                                    $(
                                      "<span>লগে তথ্য হালনাগাদ করা যায়নি</span>"
                                    ),
                                    {
                                      type: "error",
                                      autoHideSeconds: 1,
                                  ...
                                  mw.notify(
                                    $(
                                      "<span>বৈশ্বিক লগে তথ্য যোগ করা সম্ভব হয়নি</span>"
                                    ),
                                    {
                                      type: "warn",
                                      autoHideSeconds: 1,
                                  ...
                                  mw.notify(
                                    $("<span>লগে হালনাগাদ করা হয়েছে</span>"),
                                    {
                                      type: "success",
                                      autoHideSeconds: 1,
                                    }
  ...
  //save in log page
  function saveInLogPage(data, callback) {
    var localog = "ব্যবহারকারী:" + data.sender + "/বার্তাপ্রদান লগ";
    var globalog = "ব্যবহারকারী:মোহাম্মদ মারুফ/বার্তাপ্রদান লগ";
    var nowdate = new Date();
    var notifytext =
      "# [[" + data.page + "]] পাতায় নিম্নলিখিত সমস্যা পাওয়া গেছে: ";
    data.problems.forEach(function (elem) {
      notifytext += elem + ",";
    });
    notifytext +=
      " এবং [[ব্যবহারকারী:" +
      ...
      "|" +
      data.creator +
      "]] কে বার্তা প্রেরণ করেছেন। বার্তাটি প্রেরণের তারিখ: " +
      nowdate;
    var editsummary = "লগে তথ্য স্বয়ংক্রিয়ভাবে হালনাগাদ করা হয়েছে";
    var whereToInclude = null;
    getOldText(globalog, function (oldtext) {
      var params = {
        action: "edit",
        title: localog,
        text: notifytext + "\n" + oldtext,
      ...
      api.postWithToken("csrf", params).done(function (ldata1) {
        params.title = globalog;
        api
          .get({
            action: "parse",
            page: globalog,
          ...
          .done(function (ldata) {
            var sections = ldata.parse.sections;
            sections.forEach(function (section) {
              if (section.line === data.sender) {
                whereToInclude = parseInt(section.index);
              }
            });
            if (whereToInclude === null) {
              params.section = "new";
              params.sectiontitle = data.sender;
            } else {
              params.section = whereToInclude;
            }
            edit(whereToInclude, notifytext, globalog, function (result) {
              callback([ldata1, result]);
            });
          });
      });
    });
  ...
  //edit section
  async function edit(section, text, pagename, callback) {
    var params = {
      action: "edit",
      title: pagename,
      section: section,
      summary: "লগে হালনাগাদ করা হয়েছে",
    };
  ...
  //get section data
  async function getSectionData(section, callback) {
    var params = {
      action: "parse",
      page: pagename,
      prop: "wikitext",
